...
cd human_plus_nonhuman || die "Failed to cd human_plus_nonhuman"

HUMAN_ASM=${HUMAN}/${ASM}.fasta
HUMAN_BORING_BED=${HUMAN}/${ASM}_dip.boringbits.bed

NONHUMAN_CTG_FA=${NONHUMAN_PREFIX}.nonhuman_contigs.fasta
NONHUMAN_CTG_BED=${NONHUMAN_PREFIX}.nonhuman_contigs.bed
