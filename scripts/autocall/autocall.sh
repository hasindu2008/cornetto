...
NAME=$1
DATA_PATH=/directflow/KCCGGenometechTemp/projects/iradev/operation_cornetto/temp_hasindu/
...
qsub -sync y $SCRIPT_PATH/fridge_dload.sge.sh /data3/cornetto/${NAME}.blow5 ./ || die "Could not download the data"
